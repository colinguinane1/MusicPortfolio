    ...
    currentSong && (
      <motion.main>
        <div className="flex flex-col items-center">
          <div className="fixed md:ml-2 md:mb-0 mb-4 bottom-0 bg-transparent backdrop-blur-3xl md:scale-100 scale-90 px-6 rounded-lg w-full h-20 flex justify-center items-center z-[1000]">
