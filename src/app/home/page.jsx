          ...
          <div className="absolute mt-20 items-center mx-4 text-center max-w-[900px]   dark:text-white text-black">
            ...
            <div className="py-2">
              ...
              <p className=" border-b pb-4">
                I was born April 20th, 2004 in Dublin, Ireland, i have been
                making music since i was 14. I have loved film scores since I
                was a child, and felt inspired to give others the same
                experience I had when listening to film music.
                <br></br>
                <br></br>I remember it being during my Junior Certificate. when
                I should have been studying, I decided to install a free trial
                to FL-Studio and start experimenting with sounds. And now 6
                years later I enjoy writing as often as i can.
              </p>
                ...
                <div className="flex items-center py-3 mb-2 border px-3 hover:bg-slate-200 hover:border-slate-600 hover:dark:text-black hover:dark:border-black  rounded-lg">
                  <div className="flex items-center ">
                    ...
                    >
                      ...
                      />
                      <h1 className="md:text-xl font-extrabold px-3">
                        Sarah Schachner
                      </h1>
                    </a>
                  </div>
              ...
              <div id="blog" className="border-b pb-6">
            ...
            <div>
              ...
              <div className="flex flex-col items-center gap-1">
                ...
                <div className="">
                  <h1 className="font-extrabold text-2xl">HYPER</h1>
                  <h1 className="py-2">2023</h1>
                  <a className="flex flex-col items-center" href="listen">
                    <motion.button
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
